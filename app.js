            ...
            onTapRelease: function (t, e) {
              if (e)
                if (!ce && !ue && !Pt) {
                  var n = e;
                  if (Oi)
                    if ((clearTimeout(Oi), (Oi = null), ze(n, Li)))
      ...
      !(function (e, i, n) {
        ...
        function o(t) {
          ...
          if (
            ...
            if (((Lt = i.getElementById(t.skrollrBody || A)), Lt)) pt();
            tt(), xt(f, [_, k], [x]);
          } else xt(f, [_, C], [x]);
          At.refresh(),
        ...
        (o.prototype.refresh = function (t) {
          var e,
            ...
            a = false;
          if (t === n)
            (a = true), (Ot = []), (Kt = 0), (t = i.getElementsByTagName("*"));
          ...
          for (e = 0, o = t.length; e < o; e++) {
            ...
            if (el.attributes) {
              ...
              if (l.length) {
                var C, k, id;
                if (!a && F in el)
                  (id = el[F]), (C = Ot[id].styleAttr), (k = Ot[id].classAttr);
          ...
          (o.prototype.destroy = function () {
            ...
            for (var t = 0, e = Ot.length; t < e; t++) dt(Ot[t].element);
            if (
              ((f.style.overflow = c.style.overflow = ""),
              (f.style.height = c.style.height = ""),
              Lt)
            )
              a.setStyle(Lt, "transform", "none");
            (At = n),
              (Lt = n),
              (Dt = n),
              (Ft = n),
        ...
        var tt = function () {
              ...
              switch (e.type) {
                ...
                case v:
                  ...
                  var A = l.abs(S / Rt),
                    ...
                    E = At.getScrollTop() - I,
                    O = 0;
                  if (E > Mt) (O = (Mt - E) / I), (E = Mt);
                  else if (E < 0) (O = -E / I), (E = 0);
                  (A *= 1 - O),
          ...
          nt = function () {
            ...
            for (Mt = l.max(Mt, bt()), p = 0, h = Ot.length; p < h; p++) {
              for (i = Ot[p], a = i.keyFrames, s = 0, u = a.length; s < u; s++)
            ...
            for (var i = 0, n = Ot.length; i < n; i++) {
              ...
              for (var A = 0; A < c - 1; A++)
                if (u >= f[A].frame && u <= f[A + 1].frame) {
                  ...
                  for (k in I.props)
                    if (s.call(I.props, k)) {
                      var O = (u - I.frame) / (E.frame - I.frame);
                      if (
                        ((O = I.props[k].easing(O)),
                        (T = ft(I.props[k].value, E.props[k].value, O)),
                        (T = ct(T)),
                        0 === k.indexOf("@"))
                      )
                        l.setAttribute(k.substr(1), T);
          ...
          pt = function () {
            (Jt = "translateZ(0)"), a.setStyle(Lt, "transform", Jt);
            var t = u(Lt),
        ...
        var ht = (a.addEvent = function (t, names, i) {
          ...
          bt = function () {
            var t = 0,
              e;
            if (Lt) t = l.max(Lt.offsetHeight, Lt.scrollHeight);
            return (
              (e = l.max(
                t,
                c.scrollHeight,
